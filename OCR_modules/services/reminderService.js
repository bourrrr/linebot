  ...
  const messages = [
    {
      ...
      contents: {
        ...
        body: {
          ...
          spacing: 'md',
          contents: [
            { type: 'text', text: '📌 重複提醒說明', weight: 'bold', size: 'md', color: '#333333' },
            { type: 'text', text: '• 完成本步驟，解鎖抽卡資格', size: 'sm', wrap: true, color: '#555555' },
            { type: 'text', text: '• 可累積抽卡機會，每日最高可累積 3 次', size: 'sm', wrap: true, color: '#555555' },
            { type: 'text', text: '• 當日最後簽到 → 自動發送抽卡按鈕', size: 'sm', wrap: true, color: '#555555' },
            { type: 'text', text: '• 設定後可在「提醒清單」查看/刪除', size: 'sm', wrap: true, color: '#555555' }
          ]
        }
      }
    },
